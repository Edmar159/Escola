...
<div class="row">
	 <div class="row col-md-12 col-md-offset-0">    	
	   	<div class="panel panel-primary">
			...
			<form class="form-horizontal" method="GET" action="busProjFin.php" >
				...
				if(mysqli_num_rows($result) > 0)
				{
					...
					?>
						<tr>
							...
							<td>
								<a class="btn btn-default btn-xs" href="finalizaProjeto.php?cod=<?php echo $projeto->codigo; ?>" role="button"><span class="glyphicon glyphicon-save-file" aria-hidden="true"></span> Finalizar</a>
							</td>						
						</tr>
